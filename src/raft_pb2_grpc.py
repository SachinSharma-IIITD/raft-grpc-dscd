...
class RaftStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/raft.Raft/Get',
                request_serializer=raft__pb2.GetReq.SerializeToString,
                response_deserializer=raft__pb2.GetResponse.FromString,
                )
        self.Set = channel.unary_unary(
                '/raft.Raft/Set',
                request_serializer=raft__pb2.SetReq.SerializeToString,
...
def add_RaftServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=raft__pb2.GetReq.FromString,
                    response_serializer=raft__pb2.GetResponse.SerializeToString,
            ),
            'Set': grpc.unary_unary_rpc_method_handler(
                    servicer.Set,
                    request_deserializer=raft__pb2.SetReq.FromString,
...
class Raft(object):
    ...
    def AppendEntries(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/raft.Raft/AppendEntries',
            raft__pb2.AppendEntriesReq.SerializeToString,
    ...
    def Get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raft.Raft/Get',
            raft__pb2.GetReq.SerializeToString,
    ...
    def Set(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raft.Raft/Set',
            raft__pb2.SetReq.SerializeToString,
